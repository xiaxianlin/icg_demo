...
function quad(a, b, c, d) {
    ...
    normalsArray.push(normal, normal, normal, normal, normal, normal)
}
...
function init() {
    ...
    gl.uniformMatrix4fv(gl.getUniformLocation(program, 'projectViewMatrix'), false, flatten(projectionMatrix))
